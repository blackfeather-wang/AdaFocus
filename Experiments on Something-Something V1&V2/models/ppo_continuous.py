...
class ActorCritic(nn.Module):
    def __init__(self, feature_dim, state_dim, hidden_state_dim=1024, policy_conv=True, action_std=0.1, with_bn=False):
...
class PPO_Continuous:
    def __init__(self, feature_dim, state_dim, hidden_state_dim, policy_conv, gpu=0, action_std=0.1,
                 lr=0.0003, betas=(0.9, 0.999), gamma=0.7, K_epochs=1, eps_clip=0.2, with_bn=False):
        self.lr = lr
        self.betas = betas
        self.gamma = gamma
        ...
        self.policy = ActorCritic(feature_dim, state_dim, hidden_state_dim, policy_conv, action_std,
                                  with_bn=with_bn).cuda(gpu)
